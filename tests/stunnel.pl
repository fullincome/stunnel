...
my $servercert_file = $DataPath . 'srv2012.pem';
my $clientcert_file = $DataPath . 'cln2012.pem';
...
if ($ARGV[1] eq 'gost_capi') {
    $servercert_file = $DataPath . 'srv2001.pem';
    $clientcert_file = $DataPath . 'cln2001.pem';
    $cln_cert = 'cln2001';
    $srv_cert = 'srv2001';
    $engine = 'gost_capi';
}
